...
- CSS
  ...
  - [scroll.carousel.min.css](https://cdn.jsdelivr.net/npm/scroll-carousel@1.2.6/dist/scroll.carousel.min.css)

- JS
  - [scroll.carousel.min.js](https://cdn.jsdelivr.net/npm/scroll-carousel@1.2.6/dist/scroll.carousel.min.js)
...
```
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/scroll-carousel@1.2.6/dist/scroll.carousel.min.css">
```

Then, before your closing `<body>` tag, add:

```
<script src="https://cdn.jsdelivr.net/npm/scroll-carousel@1.2.6/dist/scroll.carousel.min.js"></script>
```
